...
const Login = () => {
    const { googleSingIn, githubSingIn, singInWithEmail, getEmail, getPassword, error } = useAuth();
    ...
    return (
        <div>
            ...
            <div className="mx-auto w-25">
                ...
                <span onClick={githubSingIn} className="text-3xl bg-gray-400 inline-block p-2 rounded-lg mt-3 ms-5">
                    <FaGithub />
                </span>
            </div>
